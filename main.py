...
def get_drive_service():
    if not GOOGLE_SERVICE_ACCOUNT_JSON.strip():
        raise Exception("GOOGLE_SERVICE_ACCOUNT_JSON が空です")

    raw = GOOGLE_SERVICE_ACCOUNT_JSON.strip()

    # 先頭末尾に余計なシングルクォートやダブルクォートが付いていたら除去
    ...
    try:
        ...
        raise Exception(f"GOOGLE_SERVICE_ACCOUNT_JSON のJSON形式が不正です: {e} / preview={preview}")
    ...
    try:
        ...
        raise Exception(f"Google Drive 認証情報の読み込みに失敗しました: {e}")
...
{{"ja":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}},"zh":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}},"en":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}},"ru":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}},"fr":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}}}}"""
    ...
    print("generate_ads raw:", raw[:500])

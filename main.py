...
# 画像解析用（vision対応）
GEMINI_VISION_API = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent"
# テキスト生成用
GEMINI_TEXT_API = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent"

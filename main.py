...
async def call_gemini(contents: list, max_tokens: int = 4000) -> str:
...
{{"zh":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}},"en":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}},"ru":{{"x":"...","fb":"...","tt":"...","xhs":"...","ig":"..."}}}}"""
    ...
    raw = await call_gemini([{"role": "user", "parts": [{"text": prompt}]}], max_tokens=4000)
